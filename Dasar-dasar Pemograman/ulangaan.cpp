...
struct peserta{
	...
	string nilaiHuruf;
        ...
        void DataMahasiswa()
        {
          ...
          List_Pelajaran[0].kode = 4321;
          List_Pelajaran[0].mata_kuliah = "mtk";
          List_Pelajaran[0].sks = 1;
          ...
          cin >> search;
          for (int i = 0; i < 5; i++)
            if (List_Pelajaran[i].kode == search)
            {
              position = i;
              ...
              if (position == 0)
              {
                for (int i = 0; i < 5; i++)
                {
                  cout << daspro[i].NBI <<endl;
                  cout << daspro[i].nama <<endl;
                  cout << daspro[i].nilai <<endl;
                  cout << daspro[i].nilaiHuruf <<endl;
                }
              ...
              else if (position == 1)
              {
                for (int i = 0; i < 5; i++)
                {
                  cout << sisdig[i].NBI <<endl;
                  cout << sisdig[i].nama <<endl;
                  cout << sisdig[i].nilai <<endl;
                  cout << sisdig[i].nilaiHuruf <<endl;
                }
              ...
              else if (position == 2)
              {
                ...
                {
                  cout << mtk[i].NBI <<endl;
                  cout << mtk[i].nama <<endl;
                  cout << mtk[i].nilai <<endl;
                  cout << mtk[i].nilaiHuruf <<endl;
                }
              ...
              cout << "Code tidak di temukan " <<endl;
            }
            cout << "ingin mengulang code ? [Y/T]"; loop=getche();
          } while (loop!='t');
